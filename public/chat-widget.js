...
(function () {
  ...
  var css = [
    ...
    ".lw-m.agent{background:" + MINT + ";color:" + NAVY + ";align-self:flex-start;border-bottom-left-radius:4px}",
    ".lw-m.agent .lw-agent-name{display:block;font-size:11px;font-weight:600;color:" + SAGE + ";margin-bottom:2px}",
